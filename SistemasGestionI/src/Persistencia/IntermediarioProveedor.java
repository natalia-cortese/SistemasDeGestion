...
public class IntermediarioProveedor extends IntermediarioRelacional {
    ...
    public Registro convertirObjetoRegistro(ObjetoPersistente objeto) {
        ...
        rs.addCampo(new Campo("OIDProveedor","'"+String.valueOf(proveedor.getoid())+"'"));
        ...
        if(proveedor.getbaja()== false)
            rs.addCampo(new Campo("baja",String.valueOf(0)));
        else
            rs.addCampo(new Campo("baja",String.valueOf(1)));
        return rs;
